...
extern Node * create_Node(long int key, void *container);
extern Node * rotate_node_right(Node * y);
extern Node * rotate_node_left(Node * x);
extern Node * insert_node(Node * root, long int key, void * container);
extern Node * delete_node(Node * root, long int key);
extern Node * delete_tree(Node * root);
extern Node * find_node(Node * root, long int key);
